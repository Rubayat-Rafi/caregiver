...
const Apart = () => {
    return (
        <section className="relative my-12 lg:my-20 max-w-[1440px] mx-auto w-11/12 bg-[#fe8a18] rounded-2xl">
            ...
            <div className="relative z-10 h-full flex flex-col justify-center items-center text-center p-4 sm:p-6 md:p-10 lg:p-12">
                <div className=" text-center third-text-color">
                    <h2 className="text-2xl font-black mb-4 uppercase text-white" style={{ fontFamily: "var(--font-montserrat)" }}>
                        What Sets Us Apart?
                    </h2>
                    ...
                    <button className="md:px-6 md:py-2 text-sm py-1 px-2 md:text-lg transition-all duration-300  rounded-md bg-white text-[#171717] hover:bg-gray-200 cursor-pointer">
                        Learn More
                    </button>
                </div>
            </div>
